...
# Script : Pull_HDFS_Usage.sh
# Version :v1.0
# Functioanlity : It gets the HDFS Usage at User and Group Level in Hadoop Cluster.
#

hadoop fs -ls /hawq_data /apps /Backups /hive /data /dev /user /xd /yarn /home /system /PHHD /benchmarks | grep -v "Found" | awk '{ print $3,$4,$8}' > HDFS_Aggregate.txt
